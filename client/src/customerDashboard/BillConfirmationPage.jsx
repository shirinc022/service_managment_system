...
function BillConfirmationPage() {
  ...
  return (
    ...
    <div className="bg-white dark:bg-base-900 p-8 rounded-lg shadow-lg w-full max-w-xl">
      <h2 className="text-2xl font-bold text-center text-primary mb-4">Payment Confirmation</h2>

      {/* Bill Details Section */}
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-primary mb-3">Bill Details</h3>
      ...
      <div className="flex justify-center mb-6">
        <button
          className="btn btn-primary" onClick={makePayment}> Pay Now
