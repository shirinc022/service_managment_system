      ...
      <div className="mb-6 rounded-xl overflow-hidden shadow-lg">
        ...
        >
          {serviceData.images?.map((img, index) => (
            <div
              key={index}
              className="h-[350px] md:h-[400px] lg:h-[450px] w-full"
            >
              <img
                src={img}
                alt={`Service ${index}`}
      ...
      <div className="bg-white p-6 rounded-xl shadow-md">
        ...
        <p className="text-gray-500 text-lg mt-1">
          ...
          <span className="text-primary font-semibold">
            {serviceData.provider_id?.name || "Unknown"}
          </span>
        </p>
        ...
        <p className="text-2xl font-semibold mt-5 text-primary">
          ₹ {serviceData.price}
        </p>

        {/* Book Now Button */}
        <button
          className="btn btn-primary w-full mt-6 text-lg py-3 rounded-lg shadow-lg"
      ...
      <div className="mt-8 bg-gray-50 p-6 rounded-xl shadow-md">
        ...
        {reviews.length > 0 ? (
          reviews.map((review, index) => (
            <div
              key={index}
              className="border-b last:border-none py-4 flex items-start gap-3"
            >
